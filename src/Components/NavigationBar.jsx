...
const NavigationBar = () => {
  ...
  return (
    <nav className="bg-lightDark px-[0] md:px-[3.9rem] lg:px-[11.6%]">
      <div className="pb-[3.6rem] pt-[3.2rem] text-white flex justify-between px-[2.4rem] md:px-0 border-b-[1px] border-gray">
        ...
        <div className="flex gap-[4.2rem]">
          <button className="lg:hidden md:block hidden" onClick={toggleMenu}>
            <svg width="16" height="15" xmlns="http://www.w3.org/2000/svg">
              <g fill="#FFF" fillRule="evenodd">
                <path d="M0 0h16v3H0zM0 6h16v3H0zM0 12h16v3H0z" />
              </g>
        ...
        <div className="uppercase font-bold text-[1.3rem] tracking-[2px] leading-[2.5rem]  gap-[3.4rem] hidden lg:flex">
          <NavLink className={"text-hover"} to={"/"}>
            home
          </NavLink>
          <NavLink className={"text-hover"} to={"/headphones"}>
            headphones
          </NavLink>
          <NavLink className={"text-hover"} to={"/speakers"}>
            speakers
          </NavLink>
          <NavLink className={"text-hover"} to={"/earphones"}>
            earphones
          </NavLink>
        </div>
        <button>
