...
const MenuBar = ({ toggleMenu }) => {
  return (
    <motion.div
      ...
      onClick={toggleMenu}
    >
      <div className="flex flex-col gap-[6.2rem] md:gap-0 z-50 md:flex-row  items-center justify-between bg-white px-[2.4rem] mb:px-[4rem] pb-[3.5rem] md:pb-[5.6rem] pt-[7rem] md:pt-[10rem] rounded-b-[8px]">
        <MenuLinkCard />
        <MenuLinkSpeakers />
        <MenuLinkEarphones />
      </div>
